...
- **RSC** — client hydration now has a route-scoped bundle path; add the flight protocol and client islands next.
...
| C2 | route client bundle + browser hydration gate | client interactivity | **done** |
